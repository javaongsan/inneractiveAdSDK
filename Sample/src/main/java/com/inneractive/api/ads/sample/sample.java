...
public class sample extends Activity implements InneractiveAdListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adData.put(InneractiveAd.IaOptionalParams.Key_Age, "34");
        adData.put(InneractiveAd.IaOptionalParams.Key_Gender, "F");

        InneractiveAd.displayAd(sample.this, linear, "MyCompany_MyApp", InneractiveAd.IaAdType.Banner, 60 ,adData ,sample.this);
        ...
        textBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
				 ...
				 */
                if (!InneractiveAd.displayAd(sample.this, linear, "MyCompany_MyApp", InneractiveAd.IaAdType.Text, 60, textMetaData, sample.this)){
                    noConnectivity();
                }
            }
        });
        ...
        bannerBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bannerMetaData.put(InneractiveAd.IaOptionalParams.Key_OptionalAdHeight, "50");
		    	 ...
		    	 */
                addedIaAd = new InneractiveAd(sample.this, "MyCompany_MyApp", InneractiveAd.IaAdType.Banner, 60, bannerMetaData);
                addedIaAd.setInneractiveListener(sample.this);
        ...
        rectangleBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
				 ...
				 * Load and display text ad using displayAd
				 */
                if (!InneractiveAd.displayAd(sample.this, linear, "MyCompany_MyApp", InneractiveAd.IaAdType.Rectangle, 60, rectMetaData, sample.this)){
                    noConnectivity();
                }
        ...
        interstitialBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
				 ...
				 */
                if (!InneractiveAd.displayInterstitialAd(sample.this, linear, "MyCompany_MyApp", interstitialMetaData, sample.this))
    ...
    public void noConnectivity() {
        AlertDialog alertDialog = new AlertDialog.Builder(sample.this).create();
        alertDialog.setTitle("Failed to get Ad");
        alertDialog.setMessage("Please configure your connectivity settings and re-try or check the optional parameters that you're using");
